  ...
  return (
    <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink mb-4 mt-4">
        <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <p className="w-full text-gray-600 text-xs md:text-sm px-6 mt-4">{props.data.title}</p>
            <div className="w-full font-bold text-xl text-gray-800 px-6">Version {props.data.version}</div>
            {props.data.description.map((feature, index) => 
              <p className="text-gray-800 text-base px-6 mb-5" key={index}>
                {feature}
              </p>
            )}
        </div>
            ...
            <section className="bg-white border-b py-8">
              <div className="container max-w-5xl mx-auto m-8">
                ...
                {FeatureData.map((feature, index) => {
                  ...
                  return <Features image={image} data={feature} index={index} key={index} />
                })}    
            ...
            <section className="bg-white border-b py-8">
              ...
              <div className="container mx-auto flex flex-wrap pt-4 pb-12">
                ...
                {VersionData.map((version, index) =>
                  <CardContent data={version} key={index} />
                )}            
              </div>
